# Digital Reference Material Document (DRMD) - Version 0.3.0

This folder contains the **current stable release** of the DRMD schema.

## Overview

This version (`v0.3.0`) continues the **refactored and modular structure**, improving clarity, scalability, and alignment with best practices for machine-readable certificates.
...
Use the versioned schema for v0.3.0:
...
| Schema Version Attribute | schemaVersion="0.3.0" |
